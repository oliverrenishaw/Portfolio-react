...
const Hero: React.FC = () => {
  ...
  const socialLinks = [
    {
      ...
      darkSrc: "src/assets/github-white.png",
      lightSrc: "src/assets/github-black.png",
      alt: "GitHub",
    },
    {
      href: "https://gb.linkedin.com/",
      darkSrc: "src/assets/linkedin-white.png",
      lightSrc: "src/assets/linkedin-black.png",
      alt: "LinkedIn",
    },
    {
      href: "https://x.com/",
      darkSrc: "src/assets/twitter-white.png",
      lightSrc: "src/assets/twitter-black.png",
      alt: "Twitter",
    },
  ];
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(src/assets/${theme === "dark" ? "sunset.jpg" : "lake.png"})`,
        marginTop: "-80px",
      }}
    >
