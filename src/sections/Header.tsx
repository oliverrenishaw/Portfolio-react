    ...
    <header className="fixed top-0 w-full h-16 flex items-center justify-center px-4 z-50">
      <div className="flex items-center justify-between w-full">
        ...
        <nav className={`relative hidden sm:hidden md:flex h-12 justify-center items-center space-x-2 sm:space-x-4 p-1 sm:p-2 rounded-[25px] ${theme === 'dark' ? 'bg-gradient-to-r from-[#ff9933] to-[#d5914e]' : 'bg-gradient-to-r from-[#80bbc2] to-[#bbd7e1]'}`}>
          ...
          <a href="#Resume" className="nav-link flex items-center justify-center px-1 py-1 sm:px-2 sm:py-1 md:px-4 md:py-2 text-black hover:text-white focus:text-white dark:text-white dark:hover:text-black dark:focus:text-black">Resume</a>
      ...
      >
        <nav className={`sm:block md:hidden fixed top-16 left-0 w-full flex flex-col items-start space-y-2 p-4 rounded-b-[25px] z-50 ${theme === 'dark' ? 'bg-gradient-to-b from-[#ff9933] to-[#e8a35f]' : 'bg-gradient-to-b from-[#80bbc2] to-[#bbd7e1]'}`}>
          ...
          <a href="#Resume" className="nav-link w-full text-center py-2 text-black hover:text-white focus:text-white dark:text-white dark:hover:text-black dark:focus:text-black" onClick={handleLinkClick}>Resume</a>
